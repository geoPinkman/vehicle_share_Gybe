...
public class Roles extends TableImpl<RolesRecord> {
     ...
     */
    public final TableField<RolesRecord, String> ROLE_NAME = createField(DSL.name("role_name"), SQLDataType.VARCHAR(32), this, "");
    ...
    public UniqueKey<RolesRecord> getPrimaryKey() {
        return Keys.ROLESPKEY;
    }

    @Override
    public List<UniqueKey<RolesRecord>> getKeys() {
        return Arrays.<UniqueKey<RolesRecord>>asList(Keys.ROLESPKEY);
    }
